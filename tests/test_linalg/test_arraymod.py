...
def test_constructor():
    ...
    assert list_equals(marray([1, 2, 3], 4), [1, 2, 3])
    assert list_equals(marray([1, 2, 5], 3), [1, 2, 2])

    a = marray(numpy.int64(5), 4)
    assert a[0] == 1
...
def test_eq():
    a = marray([1, 2, 3, 2, 4], 5)
    b = marray([1, 2, 3, 2, 4], 5)
    c = marray([1, 2, 3, 4, 2], 5)
    d = marray([1, 2, 3, 4, 2], 6)
...
def test_div():
    ...
    b = marray([3, 6, 6], 9)
    k = b / 6
    assert list_equals(k, [2, 1, 1]) and k._mod == 3
