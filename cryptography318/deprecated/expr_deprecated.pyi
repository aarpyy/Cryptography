...
class Add(Expr):
    ...
    def __add__(self, other: Union[int, float, Rational, Real, Expr]) -> Union[Add, NotImplemented]: ...
    def __radd__(self, other: Union[int, float, Rational, Real, Expr]) -> Union[Add, NotImplemented]: ...
    def __sub__(self, other: Union[int, float, Rational, Real, Expr]) -> Union[Add, NotImplemented]: ...
    def __rsub__(self, other: Union[int, float, Rational, Real, Expr]) -> Union[Add, NotImplemented]: ...
    def __mul__(self, other: Union[int, float, Rational, Real, Expr]) -> Union[Add, NotImplemented]: ...
    def __rmul__(self, other: Union[int, float, Rational, Real, Expr]) -> Union[Add, NotImplemented]: ...
    def __floordiv__(self, other: Union[int, float, Rational, Real, Expr]) -> Union[Add, int, NotImplemented]: ...
    def __truediv__(self, other: Any) -> NotImplemented: ...
