...
def miller_rabin(n: int, k: int = ..., *, details: dict = ...) -> bool: ...


def miller_rabin_bases(bases: list[int], n: int, *, details: dict = ...) -> bool: ...


def baillie_psw(n: int, mr: bool = ..., details: dict = ...) -> bool: ...


def known_prime(n: int) -> bool: ...


def isprime(n: int, *, details: dict = ...) -> bool: ...
